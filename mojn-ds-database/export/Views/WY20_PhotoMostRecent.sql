CREATE VIEW export.WY20_PhotoMostRecent
AS
...
HAVING        (pd.Code = 'UPSTR' OR
                         pd.Code = 'DNSTR') AND (v.SampleFrame = 'Annual') OR
                         (pd.Code = 'UPSTR' OR
                         pd.Code = 'DNSTR') AND (v.SampleFrame = '3Yr') AND (v.ParkCode = 'JOTR' OR
                         v.ParkCode = 'PARA')
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'export', @level1type = N'VIEW', @level1name = N'WY20_PhotoMostRecent';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'export', @level1type = N'VIEW', @level1name = N'WY20_PhotoMostRecent';
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "sd"
            ...
            DisplayFlags = 280
            TopColumn = 0
         End', @level0type = N'SCHEMA', @level0name = N'export', @level1type = N'VIEW', @level1name = N'WY20_PhotoMostRecent';
