...
AS
SELECT        P.Code AS ParkCode, S.Code AS SiteCode, S.Name AS SiteName, V.VisitDate, qa.Water_Year(V.VisitDate) AS VisitGroup, WaterQualityDO_1.DissolvedOxygen_percent, 
                         WaterQualityDO_1.DissolvedOxygen_mg_per_L, lookup.DataQualityFlag.Code AS DataQualityFlag, WaterQualityDO_1.DataQualityFlagNote, lookup.VisitType.Label AS VisitType, DPL.Label AS DPL
FROM            data.WaterQualityDO AS WaterQualityDO_1 INNER JOIN
                         ...
                         V.ID = data.WaterQualityActivity.VisitID AND V.ID = data.WaterQualityActivity.VisitID AND V.ID = data.WaterQualityActivity.VisitID AND V.ID = data.WaterQualityActivity.VisitID ON 
                         WaterQualityDO_1.WaterQualityActivityID = data.WaterQualityActivity.ID AND WaterQualityDO_1.WaterQualityActivityID = data.WaterQualityActivity.ID AND 
                         WaterQualityDO_1.WaterQualityActivityID = data.WaterQualityActivity.ID AND WaterQualityDO_1.WaterQualityActivityID = data.WaterQualityActivity.ID AND 
                         WaterQualityDO_1.WaterQualityActivityID = data.WaterQualityActivity.ID AND WaterQualityDO_1.WaterQualityActivityID = data.WaterQualityActivity.ID AND 
                         WaterQualityDO_1.WaterQualityActivityID = data.WaterQualityActivity.ID AND WaterQualityDO_1.WaterQualityActivityID = data.WaterQualityActivity.ID INNER JOIN
                         ...
                         WaterQualityDO_1.DataQualityFlagID = lookup.DataQualityFlag.ID AND WaterQualityDO_1.DataQualityFlagID = lookup.DataQualityFlag.ID AND 
                         WaterQualityDO_1.DataQualityFlagID = lookup.DataQualityFlag.ID AND WaterQualityDO_1.DataQualityFlagID = lookup.DataQualityFlag.ID LEFT OUTER JOIN
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'analysis', @level1type = N'VIEW', @level1name = N'WaterQualityDO';
