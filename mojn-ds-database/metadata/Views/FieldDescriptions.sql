...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'View Field Descriptions', @level0type = N'SCHEMA', @level0name = N'metadata', @level1type = N'VIEW', @level1name = N'FieldDescriptions';
